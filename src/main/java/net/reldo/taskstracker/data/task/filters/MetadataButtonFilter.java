...
@Slf4j
public class MetadataButtonFilter extends Filter
{
	private final String metadataKey;
	private final String filterConfigKey;
	private final ConfigManager configManager;

	public MetadataButtonFilter(ConfigManager configManager, String paramName, String filterConfigKey)
	{
		this.configManager = configManager;
		this.metadataKey = paramName;
